...
def _linking_order_test_macro(name, target):
    analysis_test(
        ...
        attr_values = {
            # "is_bazel": False,  # copybara-comment-this-out-please
            "is_bazel": True,  # copybara-uncomment-this-please
        },
        config_settings = {
...
def _runfiles_test_impl(env, target):
    ...
    path_suffix = "tests/builtins_bzl/cc/cc_shared_library/test"

    # condition = env.expect.that_collection(runfiles).contains_at_least_predicates  # copybara-comment-this-out-please

    condition = env.expect.that_collection(runfiles).contains_at_least_predicates  # copybara-uncomment-this-please
    condition([
        ...
        matching.str_endswith("_Sbuiltins_Ubzl_Scc_Scc_Ushared_Ulibrary_Stest/libbar_so.so"),
        matching.str_endswith("_Sbuiltins_Ubzl_Scc_Scc_Ushared_Ulibrary_Stest/libdirect_so_file.so"),
        matching.str_endswith("_Sbuiltins_Ubzl_Scc_Scc_Ushared_Ulibrary_Stest/libfoo_so.so"),
        matching.str_endswith("_Sbuiltins_Ubzl_Scc_Scc_Ushared_Ulibrary_Stest/libprivate_lib_so.so"),
        matching.str_endswith("_Sbuiltins_Ubzl_Scc_Scc_Ushared_Ulibrary_Stest/renamed_so_file_copy.so"),
        matching.str_endswith("_Sbuiltins_Ubzl_Scc_Scc_Ushared_Ulibrary_Stest3/libdiff_pkg_so.so"),
    ])
