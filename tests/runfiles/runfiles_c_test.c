...
// Exercises the public C API from a C translation unit. The full suite is
// runfiles_c_test.cc.
...
// Each CHECK* macro increments a local `int fails` on failure.
