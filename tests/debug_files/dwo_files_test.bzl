...
def _test_n_dwo_files(ctx, n):
    ...
    if target_under_test[DebugPackageInfo].dwp_file != None:
        asserts.equals(env, n, len(target_under_test[DebugPackageInfo].dwo_files.to_list()))  # copybara-uncomment-this-please
        # Internal builds link a very large set of standard libraries.
        # asserts.true(env, len(target_under_test[DebugPackageInfo].dwo_files.to_list()) > n)  # copybara-comment-this-out-please
