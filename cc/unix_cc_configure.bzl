...
def configure_unix_toolchain(repository_ctx, cpu_value, overriden_tools):
    ...
    paths = resolve_labels(repository_ctx, [
        "@rules_cc//cc:BUILD.tpl",
        "@rules_cc//cc:armeabi_cc_toolchain_config.bzl",
        "@rules_cc//cc:unix_cc_toolchain_config.bzl",
        "@rules_cc//cc:linux_cc_wrapper.sh.tpl",
        "@rules_cc//cc:osx_cc_wrapper.sh.tpl",
    ])

    repository_ctx.symlink(
        paths["@rules_cc//cc:unix_cc_toolchain_config.bzl"],
    ...
    cc_wrapper_src = (
        "@rules_cc//cc:osx_cc_wrapper.sh.tpl" if darwin else "@rules_cc//cc:linux_cc_wrapper.sh.tpl"
    )
