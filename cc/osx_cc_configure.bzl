...
load(
    "@rules_cc//cc:unix_cc_configure.bzl",
...
def configure_osx_toolchain(repository_ctx, overriden_tools):
    ...
    # Make the following logic in sync with @rules_cc//cc:cc_configure.bzl#cc_autoconf_toolchains_impl
    ...
    if xcode_toolchains:
        ...
        repository_ctx.template(
            "cc_wrapper.sh",
            paths["@rules_cc//cc:osx_cc_wrapper.sh.tpl"],
            {
