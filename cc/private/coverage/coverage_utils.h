...
/// @brief Join two path components with the platform path separator.
///
/// Mirrors @c std::filesystem::path::operator/: an absolute @p rhs replaces
/// @p lhs entirely, and an empty component is ignored.
///
/// @param lhs The leading path component.
/// @param rhs The trailing path component.
/// @return The combined path.
std::string JoinPath(const std::string& lhs, const std::string& rhs);

/// @brief Check whether an environment variable is set and non-empty.
///
/// @param name The name of the environment variable.
/// @return True when the variable is set to a non-empty value.
bool HasEnv(const char* name);

/// @brief Retrieve an environment variable, falling back to a default.
///
/// @param name The name of the environment variable.
/// @param default_value Returned when the variable is unset or empty.
/// @return The value of the variable, or @p default_value.
...
///
/// @param coverage_dir Directory holding the per-test @c *.profraw files.
...
///
/// @param coverage_dir Directory holding the per-test @c *.gcda files.
