...
def configure_windows_toolchain(repository_ctx):
    ...
    repository_ctx.symlink(
        paths["//cc/private/toolchain:windows_cc_toolchain_config.bzl"],
        "windows_cc_toolchain_config.bzl",
    )
    repository_ctx.symlink(
        paths["//cc/private/toolchain:armeabi_cc_toolchain_config.bzl"],
        "armeabi_cc_toolchain_config.bzl",
    )
    repository_ctx.symlink(
        paths["//cc/private/toolchain:msys_gcc_installation_error.bat"],
    ...
    if not vc_path:
        repository_ctx.template(
            ...
            paths["//cc/private/toolchain:vc_installation_error.bat.tpl"],
            {"%{vc_error_message}": ""},
        )
    else:
    ...
    if not vc_path or missing_tools:
        repository_ctx.template(
            "BUILD",
            paths["//cc/private/toolchain:BUILD.windows.tpl"],
            {
