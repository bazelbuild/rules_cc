...
def _impl(ctx):
    if ctx.attr.disable_static_cc_toolchains:
        fail("@rules_cc//cc/private/toolchain:default-toolchain, as well as the cc_toolchains it " +
             "points to have been removed. See https://github.com/bazelbuild/bazel/issues/8546.")
