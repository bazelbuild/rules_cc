...
toolchain(
    ...
    exec_compatible_with = [
        ...
        "@bazel_tools@bazel_tools//tools/cpp:msys",
    ],
    ...
    toolchain_type = "@bazel_tools@bazel_tools//tools/cpp:toolchain_type",
)
...
toolchain(
    ...
    exec_compatible_with = [
        "@platforms//cpu:x86_64",
        "@platforms//os:windows",
        "@bazel_tools@bazel_tools//tools/cpp:mingw",
    ],
    target_compatible_with = [
        "@platforms//cpu:x86_64",
        "@platforms//os:windows",
...
toolchain(
    ...
    exec_compatible_with = [
        "@platforms//cpu:x86_64",
        "@platforms//os:windows",
        "@bazel_tools@bazel_tools//tools/cpp:clang-cl",
    ],
    target_compatible_with = [
        "@platforms//cpu:x86_64",
        "@platforms//os:windows",
