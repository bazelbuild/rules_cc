...
def configure_unix_toolchain(repository_ctx, cpu_value, overriden_tools):
    ...
    paths = resolve_labels(repository_ctx, [
        "@bazel_tools@bazel_tools//tools/cpp:BUILD.tpl",
        "@bazel_tools@bazel_tools//tools/cpp:armeabi_cc_toolchain_config.bzl",
        "@bazel_tools@bazel_tools//tools/cpp:unix_cc_toolchain_config.bzl",
        "@bazel_tools@bazel_tools//tools/cpp:linux_cc_wrapper.sh.tpl",
        "@bazel_tools@bazel_tools//tools/cpp:osx_cc_wrapper.sh.tpl",
    ])

    repository_ctx.symlink(
        paths["@bazel_tools@bazel_tools//tools/cpp:unix_cc_toolchain_config.bzl"],
    ...
    cc_wrapper_src = (
        "@bazel_tools@bazel_tools//tools/cpp:osx_cc_wrapper.sh.tpl" if darwin else "@bazel_tools@bazel_tools//tools/cpp:linux_cc_wrapper.sh.tpl"
    )
    ...
    repository_ctx.template(
        "BUILD",
        paths["@bazel_tools@bazel_tools//tools/cpp:BUILD.tpl"],
        {
