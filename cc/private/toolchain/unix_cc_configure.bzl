...
def configure_unix_toolchain(repository_ctx, cpu_value, overriden_tools):
    ...
    repository_ctx.symlink(
        paths["//cc/private/toolchain:unix_cc_toolchain_config.bzl"],
    ...
    cc_wrapper_src = (
        "//cc/private/toolchain:osx_cc_wrapper.sh.tpl" if darwin else "//cc/private/toolchain:linux_cc_wrapper.sh.tpl"
    )
    ...
    repository_ctx.template(
        "BUILD",
        paths["//cc/private/toolchain:BUILD.tpl"],
        {
