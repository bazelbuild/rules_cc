...
load("//cc/private:cc_launcher_info.bzl", "CcLauncherInfo")
load("//cc/private:cc_shared_library_hint_info.bzl", "CcSharedLibraryHintInfo")
load("//cc/private/compile:cc_compilation_outputs.bzl", "EMPTY_COMPILATION_OUTPUTS", "create_compilation_outputs", "merge_compilation_outputs")
load("//cc/private/compile:compile.bzl", "compile")
load("//cc/private/compile:compile_build_variables.bzl", "create_compile_variables")
