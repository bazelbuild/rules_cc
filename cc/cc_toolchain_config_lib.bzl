...
def tool_path(name, path):
    ...
    Args:
        ...
        path: Location of the tool; Can be absolute path (in case of non hermetic
            toolchain), a path relative to the cc_toolchain's package, or the path of a file
            generated by the build as returned by `File.path`, e.g. of a compiler wrapper
