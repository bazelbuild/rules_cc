...
def configure_windows_toolchain(repository_ctx):
    ...
    paths = resolve_labels(repository_ctx, [
        "@rules_cc//cc:BUILD.windows.tpl",
        "@rules_cc//cc:windows_cc_toolchain_config.bzl",
        "@rules_cc//cc:armeabi_cc_toolchain_config.bzl",
        "@rules_cc//cc:vc_installation_error.bat.tpl",
        "@rules_cc//cc:msys_gcc_installation_error.bat",
    ])

    repository_ctx.symlink(
        paths["@rules_cc//cc:windows_cc_toolchain_config.bzl"],
        "windows_cc_toolchain_config.bzl",
    )
    repository_ctx.symlink(
        paths["@rules_cc//cc:armeabi_cc_toolchain_config.bzl"],
        "armeabi_cc_toolchain_config.bzl",
    )
    repository_ctx.symlink(
        paths["@rules_cc//cc:msys_gcc_installation_error.bat"],
    ...
    if not vc_path:
        repository_ctx.template(
            ...
            paths["@rules_cc//cc:vc_installation_error.bat.tpl"],
            {"%{vc_error_message}": ""},
        )
    else:
    ...
    if not vc_path or missing_tools:
        repository_ctx.template(
            "BUILD",
            paths["@rules_cc//cc:BUILD.windows.tpl"],
            {
